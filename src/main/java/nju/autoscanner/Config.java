...
public class Config {
    public static final String repoPath = "X:\\javaProjects\\sonar-scanning-examples";//必须是repo根目录
    public static final String analysePath="X:\\javaProjects\\sonar-scanning-examples\\sonarqube-scanner\\src";
    public static final String repoName = "test_time";//sonarqube扫描的名字
...
//        String cmd = "mvn clean verify sonar:sonar";
